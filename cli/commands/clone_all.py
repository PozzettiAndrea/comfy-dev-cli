...
from config import get_repos_by_category, GITHUB_OWNER, get_github_token, ALL_REPOS_DIR

console = Console()


def clone_all_repos(pull_existing: bool = False):
    ...
    console.print(f"[bold]Cloning {len(repos)} ComfyUI node repos to {ALL_REPOS_DIR}[/bold]\n")
